...
unsigned int (*hashfunction)(void *arg_0x40543320), 
int (*key_eq_fn)(void *arg_0x40543768, void *arg_0x405438e0));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0x40677558, int arg_0x406776b0);
static inline double RandomUniform(void );
...
typedef TMilli BlinkC$Timer3$precision_tag;
...
#line 83
static void BlinkC$Timer3$fired(void );
...
#line 64
static void BlinkC$Timer3$startPeriodic(uint32_t dt);
#line 64
...
# 78 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0x408ce178, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0x408ce178, msg, payload, len);
#line 78
...
# 78 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0x408d1ac8, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0x408d1ac8, msg, payload, len);
#line 78
...
# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0x408d1108, message_t * msg, error_t error){
#line 110
    TossimActiveMessageC$AMSend$default$sendDone(arg_0x408d1108, msg, error);
#line 110
}
#line 110
...
# 75 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0x407151b8){
#line 75
  switch (arg_0x407151b8) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0x407151b8);
#line 75
      break;
#line 75
    }
...
#line 87
{
  sim_log_debug(151U, "BlinkC", "I am Timer 3 and I have the shortest period!\n");
}
...
# 83 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0x40b5f3a8){
#line 83
  switch (arg_0x40b5f3a8) {
#line 83
    case 0U:
#line 83
      BlinkC$Timer0$fired();
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0x40b5f3a8);
#line 83
      break;
#line 83
    }
...
static inline void BlinkC$Boot$booted(void )
{
  ...
  BlinkC$Timer3$startPeriodic(100);
}
